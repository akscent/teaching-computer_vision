...
```{r Матрица производительности моделей}
...
В этой части мы строим модель KNN, используя функции knn() со значением k: 20
...
Затем мы строим деревья решений, используя алгоритм CART.
...
Затем мы используем библиотеку C50 для построения дерева решений C4.5.
