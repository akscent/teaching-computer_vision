---
title: 'Задание № 5: Сжатие данных. Вариант 2.'
output:
  html_document:
    df_print: paged
---
...
Данные были загружена из

[Fashion MNIST \| Kaggle](https://www.kaggle.com/datasets/zalando-research/fashionmnist)

```{r Загрузка тренировочного датасета}
fmnist <- read_csv("fashion-mnist_train.csv",
                       col_types = cols(.default = "i"))
```

Для визуализации примеров данных, преобразуем данные и запишем функии для графиков.
...
Преобразование данных : в матрицу, в нужную форму, нормализация в числа от 0 до 1.
...
Построение модели с оптимальными параметрами и проверка её качества.

```{r Результирующая модель}
